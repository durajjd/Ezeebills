...
console.log("on delete function ");
	...
	/*  view Invoice  */
	$http.post('http://localhost:8080/Ezeebills/invoice/searchInvoice?invoiceID='+invoiceNo).success(function (data) {
	...
	/*  view product  */
    $http.post('http://localhost:8080/Ezeebills/invoice/viewProduct/?id=' + invoiceNo)
...
$scope.addItemFunc = function () {
	...
	console.log("in addItem function ");
		...
		/*  Add New product  */
        $http.post('http://localhost:8080/Ezeebills/invoice/addItems?invoiceID='+$scope.invoiceNo+'&productID='+$scope.productID+'&quantity='+ $scope.quantity+'&grossAmount='+$scope.grossAmount +'&tax='+$scope.tax +'&netAmount=' + $scope.netAmount)
		.success(function (data) {
			...
			/*  view product  */
            $http.post('http://localhost:8080/Ezeebills/invoice/viewProduct/?id=' + $scope.invoiceNo)
			.success(function (data) {
                $scope.productslist = data;
                console.log($scope.productslist);
            });
...
$scope.deleteItemFunc = function () {
	...
	console.log("in update function ");
      ...
      $http.post('http://localhost:8080/Ezeebills/invoice/deleteItem?invoiceID='+$scope.invoiceNo +'&productID=' + $scope.delProductId)
		.success(function (data) {
...
console.log('go to delete result page');
 $http.post('http://localhost:8080/Ezeebills/invoice/deleteInvoice?invoiceID=' + $scope.invoiceNo)
	.success(function (data) {
        $scope.message = data;
        console.log(data);
        });
...
$scope.receivedInvoicefunc = function () {
	console.log('inside received invoice');
		$http.post('http://localhost:8080/Ezeebills/invoice/ReceivedInvoices?sellerID=' + $scope.sellerID)
	.success(function (data) {
...
$scope.sentInvoicefunc = function () {
	console.log('inside sent invoice');
		$http.post('http://localhost:8080/Ezeebills/invoice/SentInvoices?sellerID=' + $scope.sellerID)
	.success(function (data) {
		console.log("inside http");
...
$scope.approvefunc = function (invoiceNo) {
	...
	$http.post('http://localhost:8080/Ezeebills/invoice/approveInvoice?invoiceID='+invoiceNo).success(function (data) {
...
$scope.rejectfunc = function (invoiceNo) {
	console.log('inside approve invoice');
	$http.post('http://localhost:8080/Ezeebills/invoice/rejectInvoice?invoiceID='+invoiceNo).success(function (data) {
...
$scope.viewInvoicefunc = function () {
	...
	console.log("in view invoice function ");
		...
		/*  view Invoice  */
		$http.post('http://localhost:8080/Ezeebills/invoice/searchInvoice?invoiceID='+invoiceID).success(function (data) {
		...
		/*  view product  */
        $http.post('http://localhost:8080/Ezeebills/invoice/viewProduct/?id=' + invoiceID)
		.success(function (data) {
            $scope.productslist = data;
            console.log($scope.productslist);
        });
...
window.location = "InvoiceIndex.html"; 
}
...
window.location = "EzeeIndex.html"; // Redirecting to other page.
return false;
}
else{
